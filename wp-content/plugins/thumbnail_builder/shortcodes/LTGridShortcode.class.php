...
class ByButtonShortcode {
    ...
    function render( $args, $content = '') {
        ...
        return do_shortcode('[vc_btn title="'.$bb_title.'" color="danger" align="center" el_class="t-buy-tickets-btn" link="url:'.urlencode($bb_button_url).'|title:'.urlencode($bb_title).'||" ]');
