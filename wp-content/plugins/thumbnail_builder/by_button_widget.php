...
if( class_exists('WP_Widget') && !class_exists('ByButtonWidget')) {
    ...
    class ByButtonWidget extends WP_Widget
    {
        ...
        public function widget($args, $instance)
        {
            ...
            echo '<div class="textwidget by-button-widget">';
                echo $bb_text_html;
                echo do_shortcode('[vc_btn title="'.$bb_title.'" color="danger" align="center" el_class="t-buy-tickets-btn clr" link="url:'.urlencode($bb_button_url).'|title:'.urlencode($bb_title).'||" ]');
            echo '</div>';
